...
<!-- <link rel="preconnect dns-prefetch" href="//fonts.googleapis.com"> -->
<!-- ↑ Noto SansをCocoonではなく自分で使うことにしたので、それに合わせて「CocoonでWebフォントを選ぶと自動で上の方に表示されていたdns-prefetchが消えたのでここにあるものをコメントアウトして上に移動した。結果的にダブりをなくせたし"preconnect"のrel値が入っているものを使えたのでOK（Cocoon自動表示のやつは"dns-prefetch"しかなかった） -->
...
<!-- Preload -->
<? /* icomoon完全排除したので読み込みやめます_20201218
...
<script>
    ...
    })(window, document, "clarity", "script", "5j1zvo42ky");
</script>
